...
//
// private SolicitacaoResponseDTO responseDto(Long id, SolicitacaoAssunto
// assunto, String body) {
...
// }
//
// private SolicitacaoCreateDTO createDto(SolicitacaoAssunto assunto, String
// body) {
...
//
// mockMvc.perform(get("/api/solicitacoes/").accept(MediaType.APPLICATION_JSON))
...
// SolicitacaoResponseDTO dto1 = responseDto(1L, SolicitacaoAssunto.BURACO,
// "Corpo 1");
// SolicitacaoResponseDTO dto2 = responseDto(2L, SolicitacaoAssunto.ESGOTO,
// "Corpo 2");
//
...
//
// @Test
// @DisplayName("GET /api/solicitacoes/{id} retorna 200 com solicitação
// encontrada")
// void testGetByIdRetorna200QuandoEncontrada() throws Exception {
// SolicitacaoResponseDTO dto = responseDto(1L, SolicitacaoAssunto.ESGOTO, "Test
// Body");
//
// given(service.getSolicitacaoById(1L)).willReturn(dto);
//
// mockMvc.perform(get("/api/solicitacoes/1").accept(MediaType.APPLICATION_JSON))
// .andExpect(status().isOk())
// .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
...
//
// @Test
// @DisplayName("GET /api/solicitacoes/{id} retorna 404 quando não encontrada")
...
//
// mockMvc.perform(get("/api/solicitacoes/999").accept(MediaType.APPLICATION_JSON))
...
// SolicitacaoCreateDTO createDto = createDto(SolicitacaoAssunto.BURACO, "Novo
// Corpo");
// SolicitacaoResponseDTO responseDto = responseDto(1L,
...
//
// @Test
// @DisplayName("PATCH /api/solicitacoes/{id} retorna 200 com dados
// atualizados")
...
// SolicitacaoResponseDTO responseDto = responseDto(1L,
// SolicitacaoAssunto.BURACO, "Corpo Atualizado");
//
...
//
// @Test
// @DisplayName("PATCH /api/solicitacoes/{id} retorna 404 quando recurso não
// existe")
...
//
// @Test
// @DisplayName("DELETE /api/solicitacoes/{id} retorna 204 quando deletada com
// sucesso")
...
//
// @Test
// @DisplayName("DELETE /api/solicitacoes/{id} retorna 404 quando recurso não
// existe")
// void testDeleteRetorna404QuandoRecursoNaoExiste() throws Exception {
// doThrow(new NotFoundException("Solicitação não encontrada com id 999"))
