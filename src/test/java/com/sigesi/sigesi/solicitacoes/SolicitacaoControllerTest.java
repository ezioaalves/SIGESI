...
class SolicitacaoControllerTest {
  ...
  @Test
  @DisplayName("DELETE /api/solicitacoes/{id} retorna 204 quando deletada com sucesso")
  ...
  @Test
  @DisplayName("DELETE /api/solicitacoes/{id} retorna 404 quando recurso não existe")
