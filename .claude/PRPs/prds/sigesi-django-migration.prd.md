...
| 3 | Authentication & Authorization | Google OAuth2 via django-allauth, role-based permissions | in-progress | - | 2 | `.claude/PRPs/plans/django-migration-phase3-authentication.plan.md` |
